...
import clarification9 from "../../../data/de/Clarification9.md";
import sar from "../../../data/de/SAR.md";
import uniforms from "../../../data/de/AthleteUniformRegulations.md";
import sandRegulations from "../../../data/de/SandRegulations.md";
